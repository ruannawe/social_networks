defmodule SocialNetworksWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SocialNetworksWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SocialNetworksWeb.Gettext, "errors", msg, opts)
    end
  end
